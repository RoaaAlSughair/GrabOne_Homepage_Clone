    ...
    <div>
      ...
      <div className="initial-display">
          ...
          <div className="sidebar-categories">
            <ul className="side-categories">
              {categories.map((elem, i) => {
                return (
                  <li className="side-category" key={i}>
                    <Link className="sidebar-links">{elem}</Link>
                  </li>
                );
              })}
            </ul>
        ...
        <Card key={1}>
          <Card.Img
            variant="top"
            src="https://main-cdn.grabone.co.nz/goimage/fullsize/d3162da6dbd501bca97675ef50ed44b23cffd04f.jpg"
          />
          <Card.Body>
            <Card.Title className="card-title">
              <h3 className="small-card-title">
                Inclusive Hanmer Springs Gateway
              </h3>
            </Card.Title>
            <Card.Subtitle>
            ...
            <Card.Text>
              <h4 className="card-city">Christchurch</h4>
            </Card.Text>
          </Card.Body>
        ...
        <Card key={2}>
          <Card.Img
            variant="top"
            src="https://main-cdn.grabone.co.nz/goimage/fullsize/32286725841603f9c33fc6257a8b797d24738be8.jpg"
          />
          <Card.Body>
            <Card.Title className="card-title">
              <h3 className="small-card-title">Mesh Reusable Face Mask</h3>
            </Card.Title>
            <Card.Subtitle>
              <br />
            </Card.Subtitle>
      ...
      <div className="subscribe">
        <p className="order-to-subscribe">
          Get the best deals delivered direct to your inbox each day
        </p>
        <InputGroup className="Newsletter input-form">
